...
object Mailboxes extends App {
  ...
  // step 2 - make ir know in the configuration
  // step 3 - attach a distpacher to an actor
  ...
  supportTicketLogger ! "[P0] this needs to be solved MOW"
  supportTicketLogger ! "[P1] do this as soon as you finish your higher priorities"*/
  ...
  controlAwareActor ! "[P1] do this as soon as you finish your higher priorities"
  ...
  altControlAwareActor ! "[P1] do this as soon as you finish your higher priorities"
